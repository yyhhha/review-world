...
public class ReviewServiceSilver {
	private ReviewServiceSilver() {}
	
	private static ReviewServiceSilver instance = new ReviewServiceSilver();
	
	public static ReviewServiceSilver getInstance() {
		return instance;
	}
